...
<?php
$result = mysqli_query($mysqli, "SELECT * FROM siswa ORDER BY nama ");
?>
<html>
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary mb-3">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <form action="delete.php" method="GET" class="d-flex" role="search">
                    ...
                    <a class="btn btn-danger" href="delete.php" type="button">
                        Reset
                    </a>
                </form>
            </div>
    ...
    <div class="container">
        ...
        <figure>
            <blockquote class="blockquote">
                <p>Apakah anda ingin mendelete Data Siswa yang telah disimpan</p>
            </blockquote>
        </figure>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <center>
                                    <a href="trash.php?id=<?php echo $user_data['id']; ?>" type="button" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda Yakin?')">
